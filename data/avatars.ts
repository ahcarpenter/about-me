...
/**
 * Recommender avatars, keyed by the recommendation's `name` field.
...
export const recommenderAvatars: Record<string, StaticImageData> = {
  "John Chaffier": johnChaffier,
  "Christian Hughes": christianHughes,
  "Rick Peyton": rickPeyton,
  "Patrick Taylor": patrickTaylor,
  "Ronaldus van Uden": ronaldusVanUden,
};
